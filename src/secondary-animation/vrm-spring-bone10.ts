 ...
 */
export class VRMSpringBone10 {
    public verlets: VRMSpringBoneLogic10[] = [];
    ...
    //             this.verlets.push(new VRMSpringBoneLogic10(this.center, this.hitRadius, b));
    //         });
    //     });
    ...
    //             const scene = collider.transform.getScene();
    ...
    //                 const mat = new StandardMaterial(collider.transform.name + '_colliderGizmomat', scene);
    ...
    public async update(deltaTime: number): Promise<void> {
        ...
        const promises = this.verlets.map<Promise<void>>((verlet) => {
            return new Promise<void>((resolve) => {
                ...
                verlet.update(this.colliderGroups, deltaTime)
                resolve();
            });
        });
